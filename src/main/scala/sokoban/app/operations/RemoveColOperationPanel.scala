...
import sokoban.lib.operations.{RemoveColOperation, RemoveRowOperation, RowColChangePos}

import scala.swing.{ButtonGroup, GridPanel, Panel, RadioButton}

class RemoveColOperationPanel private(val inner: GridPanel) extends OperationPanel with RemoveColOperation {
