...
import sokoban.lib.operations.{AddColOperation, AddRowOperation, RowColChangePos}

import scala.swing.{ButtonGroup, GridPanel, Panel, RadioButton}

class AddColOperationPanel private(val inner: GridPanel) extends OperationPanel with AddColOperation {
